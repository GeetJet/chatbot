...
music_player = tkr.Tk()
music_player.title('Audio Procedures')
...
Button1 = tkr.Button(music_player, width=5, height=3, font='Helvetica 12 bold', text='PLAY', command=play, bg='grey',
                     fg='white')
Button2 = tkr.Button(music_player, width=5, height=3, font='Helvetica 12 bold', text='STOP', command=stop, bg='#99ccff',
                     fg='white')
Button3 = tkr.Button(music_player, width=5, height=3, font='Helvetica 12 bold', text='PAUSE', command=pause,
                     bg='grey', fg='white')
Button4 = tkr.Button(music_player, width=5, height=3, font='Helvetica 12 bold', text='RESUME', command=unpause,
                     bg='#99ccff', fg='white')
